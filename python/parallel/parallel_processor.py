...
from parallel.spatial_loader import SpatialDataLoader
from parallel.output_manager import OutputDirManager
from parallel.cluster_merger import ClusterMerger
...
class ParallelClusterProcessor:
    ...
    def __init__(self,config):
        ...
        self.spatial_file = config.spatial_file_path
    ...
    def parallel_cluster_merger(self):
        ...
        txt_output_dir = output_creator.create_output_dir()
