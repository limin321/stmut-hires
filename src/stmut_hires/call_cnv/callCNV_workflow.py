...
from stmut_hires.visualization.cluster_totalreads import ClusterTotalReads
from stmut_hires.visualization.cnv_sorted_bycluster_plot import CNVSortedbyClusters
from stmut_hires.visualization.unrooted_cnv_clustered_plot import UnrootedCNVHeatmap
from stmut_hires.visualization.analysis_plots import AnalysisVisualizer
from stmut_hires.call_cnv.cnvscore_orchestrators import CNVSortedByBulkCNV
from stmut_hires.call_cnv.barcode_quintile import AssignBarcodeQuintile
...
class CNVCallPlotWorkflow:
    ...
    def __init__(self, config):
        ...
        self.graph_based_csv = config.clusterf
        self.annotate_csv = config.annotate_csv
