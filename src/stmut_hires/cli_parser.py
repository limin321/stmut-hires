...
class CommandLineParser:
    ...
    def parse_args():
        ...
        canonical_parent.add_argument("--spatial_file",help="Barcodes spatial coordinates.(./spatial/tissue_positions.parquet)")
        canonical_parent.add_argument("--cluster_file", help="Barcodes cluster info.(csv);Graph-based.csv downloaded from Loupe Browser.")
        ...
        cnv_parent.add_argument("--pmtimes", default=5, type=int, help="The number of permutation times.")
        cnv_parent.add_argument("--ncluster", default=6, type=int, help="Number of clusters for CNV plot.")
